...
<head>
  ...
  <meta name="author" content="Bayerboard">
  <meta name="keyword" content="Bayerboard, Bootstrap, Admin, Template, Theme, Responsive, Fluid, Retina">
  <title>Bayerio - Bootstrap Admin Template</title>
  ...
  <!-- =======================================================
    Template Name: Bayerio
    Template URL: https://templatemag.com/Bayerio-bootstrap-admin-template/
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="img/logo.png"  width="190"></a></p>
          
          <li class="mt">
            <a href="index.html">
              <i class="fa fa-Bayerboard"></i>
              <span>Bayerboard</span>
              </a>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
